...
view =
    Element.column [ Element.width Element.fill, Element.spacing 24 ]
        [ Title.title "Page" |> Title.withH1 |> Title.toMarkup
        ...
        , exampleSection "Basic page structure"
            (Element.el [ Element.width Element.fill, Element.height (Element.px 300) ]
                (Page.page
                    ...
                    |> Page.withMasthead
                        (Element.el [ Bg.color (Element.rgb255 21 21 21), Element.width Element.fill, Element.padding 12, Font.color Tokens.colorTextOnDark, Font.size 14 ]
